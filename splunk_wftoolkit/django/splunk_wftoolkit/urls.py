...
urlpatterns = patterns('',
    ...
    url(r'^parallelcoords/$', render('splunk_wftoolkit:parallelcoords.html'), name='parallelcoords'),
    ...
    url(r'^punchcardsearch/$', render('splunk_wftoolkit:punchcardsearch.html'), name='punchcardsearch'),
