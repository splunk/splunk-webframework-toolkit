...
urlpatterns = patterns('',
    ...
    url(r'^globe/$', render('wftoolkit:bubbles.html'), name='bubbles'),
    url(r'^globe/$', render('wftoolkit:calheat.html'), name='calheat'),
    url(r'^globe/$', render('wftoolkit:parsets.html'), name='parsets'),
    url(r'^globe/$', render('wftoolkit:parcoords.html'), name='parcoords'),
    url(r'^globe/$', render('wftoolkit:forcedirected.html'), name='forcedirected'),
    # Examples
