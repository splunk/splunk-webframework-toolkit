...
@render_to('wftoolkit:setup.html')
@login_required
def setup(request):
    ...
    return create_setup_view_context(
        ...
        # NOTE: Most apps should redirect to the home view 'wftoolkit:home'
        #       instead of back to the setup page.
        reverse('wftoolkit:setup'))  # where to redirect after the completing the setup view